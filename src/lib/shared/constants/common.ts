...
export const mockGame = {
  ...
  "screenshots": [],
  "slug": "furry-holes",
  "summary": "Furry Holes - is a classic 2D game in the memory genre which is about you find the same pictures and enjoy different images of furry beautiful ladies.",
  "themes": [
      1,
      42
  ],
